...
-- 5. ПРЕДЫСТОРИИ И МИРОВОЗЗРЕНИЯ
CREATE TABLE IF NOT EXISTS backgrounds (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, name TEXT NOT NULL, starting_proficiencies_json TEXT, language_options_json TEXT, starting_equipment_json TEXT, feature_index TEXT, feature_name TEXT, feature_desc TEXT, personality_traits_json TEXT, ideals_json TEXT, bonds_json TEXT, flaws_json TEXT, starting_equipment_options_json TEXT);
...
-- 7. СНАРЯЖЕНИЕ
CREATE TABLE IF NOT EXISTS equipment (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, name TEXT NOT NULL, category_index TEXT, cost_json TEXT, weight REAL, description TEXT, armor_class_json TEXT, str_minimum INTEGER, stealth_disadvantage INTEGER, damage_json TEXT, range_json TEXT, properties_json TEXT, contents_json TEXT);
CREATE TABLE IF NOT EXISTS weapons (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, label TEXT NOT NULL, category_index TEXT, damage_dice TEXT, damage_type TEXT, cost TEXT, weight REAL, properties_json TEXT, rarity TEXT);
CREATE TABLE IF NOT EXISTS armor (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, name TEXT NOT NULL, category_index TEXT, ac_base INTEGER, dex_bonus INTEGER, max_bonus INTEGER, str_minimum INTEGER, stealth_disadvantage INTEGER, cost TEXT, weight REAL, rarity TEXT);
CREATE TABLE IF NOT EXISTS magic_items (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, name TEXT NOT NULL, description TEXT, category_index TEXT, rarity TEXT, variant INTEGER, variants_json TEXT, image_url TEXT, reference_json TEXT);
...
CREATE TABLE IF NOT EXISTS equipment_categories (id INTEGER PRIMARY KEY AUTOINCREMENT, index_name TEXT NOT NULL UNIQUE, name TEXT);
CREATE TABLE IF NOT EXISTS equipment_category_links (id INTEGER PRIMARY KEY AUTOINCREMENT, category_index TEXT NOT NULL, item_index TEXT NOT NULL, UNIQUE(category_index, item_index));