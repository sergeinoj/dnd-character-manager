...
data class BackgroundEntity(
    ...
    @ColumnInfo(name = "starting_equipment_json") val startingEquipmentJson: String?,
    @ColumnInfo(name = "starting_equipment_options_json") val startingEquipmentOptionsJson: String?,
    @ColumnInfo(name = "starting_gold", defaultValue = "0") val startingGold: Int? = 0,
...
@Entity(
    ...
    indices = [
        ...
        Index(value = ["cost_cp"], name = "index_equipment_cost_cp")
    ]
)
data class EquipmentEntity(
    ...
    @ColumnInfo(name = "damage_json") val damageJson: String?,
    @ColumnInfo(name = "range_json") val range_json: String?,
    ...
    @ColumnInfo(name = "cost_cp", defaultValue = "0") val costCp: Int?
)
...
@Entity(
    ...
    indices = [
        ...
        Index(value = ["cost_cp"], name = "index_weapons_cost_cp")
    ]
)
...
@Entity(
    ...
    indices = [
        ...
        Index(value = ["cost_cp"], name = "index_armor_cost_cp")
    ]
)
...
@Entity(
    ...
    indices = [
        ...
        Index(value = ["cost_cp"], name = "index_magic_items_cost_cp")
    ]
)
