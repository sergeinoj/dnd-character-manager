// Имя файла: app/src/main/java/com/dnd/app/ui/debug/DraftInspectorSheet.kt
// --- НАЧАЛО ФАЙЛА ---
...
/**
 * Главный экран инспектора.
 * Является "чистым" компонентом, принимающим состояние и коллбэк для закрытия.
 * Не имеет собственной ViewModel или бизнес-логики.
 */
@OptIn(ExperimentalMaterial3Api::class) // ИСПРАВЛЕНО: Добавлена аннотация для TopAppBar
@Composable
fun DraftInspectorSheet(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            contentPadding = PaddingValues(all = 12.dp), // ИСПРАВЛЕНО: contentPaddingValues -> PaddingValues
