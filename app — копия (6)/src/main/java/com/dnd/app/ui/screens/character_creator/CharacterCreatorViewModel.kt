...
class CharacterCreatorViewModel @Inject constructor(
    ...
    private fun loadInitialData() {
        viewModelScope.launch {
            ...
            // ПАРАЛЛЕЛЬНАЯ ИНИЦИАЛИЗАЦИЯ справочников (async/await)
    ...
    // [STABILITY FIX] Восстановление Public API для UI-слоя
    fun prepareClassTab() {
        // Заглушка для совместимости с будущим рефакторингом вкладок.
        // Сейчас данные грузятся автоматически при выборе класса.
    }
