...
fun StatsStep(
    ...
    aggregateBonuses: Map<String, Int>, // ИЗМЕНЕНО: Принимаем единую карту бонусов
            ...
            Row(
                ...
                rowStats.forEach { (name, key) ->
                    StatSquareItem(
                        ...
                        totalBonus = aggregateBonuses[key] ?: 0, // ИЗМЕНЕНО
...
fun StatSquareItem(
    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = "8 + $pointsAboveBase + $totalBonus", // ИЗМЕНЕНО
                fontSize = 10.sp,
                color = Color.Gray,
