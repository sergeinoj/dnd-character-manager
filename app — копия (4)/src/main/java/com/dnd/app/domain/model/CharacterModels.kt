...
data class Race(
    ...
    val speed: Int,
    // Прямые бонусы из таблицы races (v1.23)
    val baseStats: Map<String, Int> = emptyMap(),
    // Базовые владения (например, Внимательность у эльфов)
    val baseProficiencies: List<String> = emptyList(),
    // Выборы, зашитые в саму расу (например, инструменты Дварфа или навыки Полуэльфа)
...
data class Background(
    ...
    // [ИЗМЕНЕНО] Добавлено поле для статического снаряжения
