// Имя файла: F:/app/D&D/app/src/main/java/com/dnd/app\data\repository\datasource\SpellDataSource.kt
// --- НАЧАЛО ФАЙЛА ---
...
interface SpellDataSource {
    ...
    suspend fun getSpellsByLevelRange(minLevel: Int, maxLevel: Int, classIndex: String): List<Spell>
