// Имя файла: F:/app/D&D/app/src/main/java/com/dnd/app\data\local\ReferenceDatabase.kt
// --- НАЧАЛО ФАЙЛА ---
...
@Database(
    entities = [
        ...
        MonsterEntity::class,
        MonsterActionEntity::class,
        MonsterAttackPatternEntity::class,
        MonsterAttackPatternEntryEntity::class,
        MonsterActionEffectEntity::class,
        MonsterSpecialAbilityEntity::class,
        MonsterLegendaryActionEntity::class,
        MonsterReactionEntity::class,
        MonsterProficiencyEntity::class,
        MonsterDamageModEntity::class
    ],
    version = 7,
    exportSchema = false
)
