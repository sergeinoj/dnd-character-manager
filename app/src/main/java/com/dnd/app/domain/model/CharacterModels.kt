// Имя файла: F:/app/D&D/app/src/main/java/com/dnd/app\domain\model\CharacterModels.kt
// --- НАЧАЛО ФАЙЛА ---
...
data class ClassInfo(
    ...
    val name: String,
    val hitDie: Int,
    val primaryStat: String = "CHA",
    val casterType: String? = null,
    val casterWeight: Double = 0.0,
    val subclasses: List<SubclassInfo> = emptyList(),
    val multiclassRequirements: List<MulticlassRequirement> = emptyList()
)
