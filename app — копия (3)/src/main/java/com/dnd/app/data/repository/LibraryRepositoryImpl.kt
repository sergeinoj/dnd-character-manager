...
class LibraryRepositoryImpl @Inject constructor(
    ...
    override suspend fun getClassFeaturesForLevel(classIndex: String, level: Int, subclassIndex: String?): ClassFeaturesForLevel =
        getFeaturesForLevelUseCase(classIndex, level, subclassIndex)

    // --- DictionaryDataSource Delegation ---
    override suspend fun getAllBackgrounds(): List<Background> = dictionarySource.getAllBackgrounds()
    ...
    override suspend fun searchEquipment(query: String): List<EquipmentEntity> = dictionarySource.searchEquipment(query)
    ...
    override suspend fun getAllEquipmentCategories(): List<EquipmentCategoryEntity> = dictionarySource.getAllEquipmentCategories()
    // [ИСПРАВЛЕНО] Реализован недостающий метод
    override suspend fun getEquipmentByCategory(categoryIndex: String): List<EquipmentEntity> = dictionarySource.getEquipmentByCategory(categoryIndex)
